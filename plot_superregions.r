...
plot_antarctica(Xc,Yc,map_dhdt_model,mask_ice,mask_super,breaks=brks,col=col,title="dH/dt (2000-2010) [Gt/yr]")
graphics.off()
...
plot_antarctica(Xc,Yc,map_dhdt_model_m,mask_ice,mask_super,breaks=brks,col=col,title="dH/dt (2000-2010) [m/yr]")
graphics.off()
...
brks   = seq(-150,1550,by=50)
col    = colorRampPalette(palette2, bias=3.75)(length(brks)-1)

myfigure(outfldr,"map_prec_current_perc",type="png",asp=1.2,pointsize=12)
plot_antarctica(Xc,Yc,map_prec_current_percent,mask_ice,mask_super,breaks=brks,col=col,title="Snow precipitation offset (2000-2010) [%]")
...
plot_antarctica(Xc,Yc,map_dHdT_071_100,mask_ice,mask_super,breaks=brks,col=col,title="dH/dt (2071-2100) [Gt/yr]")
...
plot_antarctica(Xc,Yc,map_dHdT_071_100_m,mask_ice,mask_super,breaks=brks,col=col,title="dH/dt (2071-2100) [m/yr]")
graphics.off() #This is the projected net mass balance for the period 2071-2100
