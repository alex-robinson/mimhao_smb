...
image.plot(Xc,Yc,map_gl,zlim=brks,col=col)
...
brks = seq(z1,z2,by=zint)
col=colorRampPalette(c("darkmagenta","darkblue","blue", "khaki1","red","red4"))(length(brks)-1)
image.plot(Xc,Yc,map_if,zlim=brks,col=col)
...
brks = seq(z1,z2,by=zint)
col=colorRampPalette(c("darkmagenta","darkblue","blue","khaki1","red","red4"))(length(brks)-1)
image.plot(Xc,Yc,map_bm,zlim=brks,col=col)
title("Basal melt")
contour(Xc,Yc,mask_ice,add=TRUE,levels=c(0,2,3),drawlabels=FALSE,lwd=3,col="grey50")
dev.off()
...
brks = seq(z1,z2,by=zint)
col=colorRampPalette(c("darkmagenta","darkblue","blue","khaki1","red","red4"))(length(brks)-1)
image.plot(Xc,Yc,map_smb,zlim=brks,col=col)
...
brks = seq(z1,z2,by=zint)
col=colorRampPalette(c("darkmagenta","darkblue","blue","khaki1","red","red4"))(length(brks)-1)
image.plot(Xc,Yc,map_smb_81_10,zlim=brks,col=col)
...
brks = seq(z1,z2,by=zint)
col=colorRampPalette(c("darkmagenta","darkblue","blue","khaki1","red","red4"))(length(brks)-1)
image.plot(Xc,Yc,map_smb_00_10,zlim=brks,col=col)
...
zlim = c(range(map_dsmb_001_030, na.rm=TRUE))
z1 = zlim[1]
z2 = zlim[2]
zint = 10
brks = seq(z1,z2,by=zint)
col=colorRampPalette(c("darkmagenta","darkblue","blue","khaki1","red","red4"))(length(brks)-1)
image.plot(Xc,Yc,map_dsmb_001_030,zlim=brks,col=col)
...
brks = seq(z1,z2,by=zint)
col=colorRampPalette(c("darkmagenta","darkblue","blue","khaki1","red","red4"))(length(brks)-1)
image.plot(Xc,Yc,map_dsmb_071_100,zlim=brks,col=col)
...
brks = seq(z1,z2,by=zint)
col=colorRampPalette(c("darkmagenta","darkblue","blue","khaki1","red","red4"))(length(brks)-1)
image.plot(Xc,Yc,map_dhdt,zlim=brks,col=col)
title("Surface mass balance change (A1B 2071-2100)")
contour(Xc,Yc,mask_ice,add=TRUE,levels=c(0,2,3),drawlabels=FALSE,lwd=3,col="grey50")
dev.off()
