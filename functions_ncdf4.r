#Script modified to work with ncdf4

#' @export
get.nc4 <- function(file,convert=1,vnms=NA,month=-1,missing=1e10,fliplat=TRUE,shiftlon=TRUE)
{
    ...
    for ( j in 1:length(vnms) ) {
        ...
        #cat("vnm:",vnm,"\n")
        out[[vnm]] <- ncdf4::ncvar_get( nc, v3, start=start, count=count )
